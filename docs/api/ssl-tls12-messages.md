...
Generated from `src/ssl-tls12-messages.ads` by `ssllib_tools docs`. The prose is the specification's own; nothing here is written twice.

The three handshake messages TLS 1.2 has and TLS 1.3 does not:
