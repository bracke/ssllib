...
Generated from `src/ssl-authentication.ads` by `ssllib_tools docs`. The prose is the specification's own; nothing here is written twice.

What authenticated a peer, and how -- as a value an application can
