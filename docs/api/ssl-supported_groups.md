...
Generated from `src/ssl-supported_groups.ads` by `ssllib_tools docs`. The prose is the specification's own; nothing here is written twice.

The named groups this library will agree a shared secret over, and
